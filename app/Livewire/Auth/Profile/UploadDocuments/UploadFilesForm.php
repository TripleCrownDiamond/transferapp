...
class UploadFilesForm extends Component
{
    use WithFileUploads;
    ...
    public function uploadFiles1()
    {
        ...
        if ($validate_files) {
            ...
            if ($accounts->isNotEmpty()) {
                ...
                if (count($files) === 0) {
                    $this->profileScore = intval($account->profile_completion_percentage) + 20;
    ...
    {
        return view('livewire.auth.profile.upload-documents.upload-files-form');
    }
}
