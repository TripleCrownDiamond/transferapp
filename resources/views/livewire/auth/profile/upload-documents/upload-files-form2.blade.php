<div>
    <h3>{{ __('upload-documents.upload_files.upload_files_title2') }}</h3>
    <form class="mb-4" method="post" wire:submit.prevent="uploadFiles1">
        <div class="mb-3">
            ...
            <select class="form-control" id="file_type_id_2" name="file_type_id" wire:model="file_type_id"
        ...
        <div class="mb-3">
            ...
            <input class="form-control" wire:model="file1" type="file" id="file1_2">
            @error('file1')
                <small class="text-danger">{{ $message }}</small>
                <br>
            @enderror
        ...
        @if ($showFile2)
            <div class="mb-3">
                ...
                <input class="form-control" wire:model="file2" type="file" id="file2_2">
                @error('file2')
                    <small class="text-danger">{{ $message }}</small>
                    <br>
                @enderror
