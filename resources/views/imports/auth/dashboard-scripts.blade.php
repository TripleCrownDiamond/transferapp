...
<script src={{ asset('profile-dropdown/js/jquery-3.3.1.min.js') }}></script>
<script src={{ asset('profile-dropdown/js/popper.min.js') }}></script>
<script src={{ asset('profile-dropdown/js/bootstrap.min.js') }}></script>
<script src={{ asset('profile-dropdown/js/owl.carousel.min.js') }}></script>
<script src={{ asset('profile-dropdown/js/main.js') }}></script>
...
<script src={{ asset('theme/assets/js/soft-ui-dashboard.min.js?v=1.0.7') }}></script>
<!-- SweetAlert2 JS -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src={{ asset('js/swal.js') }}></script>
<script src={{ asset('js/confirm-logout.js') }}></script>
